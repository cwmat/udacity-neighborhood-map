...
var ViewModel = function() {
    ...
    this.currentList = ko.computed(function() {
        ...
        // var thisList = ko.observableArray([]);
        // cycleFilter("all", thisList)
        ...
        for (var i = 0; i < self.layerList().length; i++) {
          // console.log("made it to the for");
        ...
        // use a switch statement to test "self.filterOption"
        // switch (self.filterOption) {
        //   case "all":
        //     cycleFilter("all", thisList);
        //     break;
        //   case "food":
        //     cycleFilter("food", thisList);
        //     break;
        //   case "beer":
        //     cycleFilter("beer", thisList);
        //     break;
        //   case "coffee":
        //     cycleFilter("coffee", thisList);
        //     break;
        //   default:
        // }
        // return thisList;
      ...
      // console.log(self.tempList()[0]);
      // this.originList = ko.observableArray([]);

      // this.cycleFilter = function(inputType, thisList) {
      //   for (var i = 0; i < self.layerList().length; i++) {
      //     if (self.layerList()[i].type() == inputType) {
      //       thisList.push(self.layerList()[i].marker().setMap(map))
      //     }
      //   }
      // }
      ...
      this.removeItem = function(data) {
        self.layerList.remove(data);
      };

      // this.currentLayerList = ko.observableArray([]);
      // this.currentLayerFilter = ko.observable();
      // this.filterLayers = ko.computed(function() {
      //       if(!self.currentLayerFilter()) {
      //           return self.currentLayerList();
      //       } else {
      //           return ko.utils.arrayFilter(self.currentLayerList(), function(lyr) {
      //               return lyr.genre == self.currentLayerFilter();
      //           });
      //       }
      //   });

      // this.filteredLayers = ko.computed(function() {
